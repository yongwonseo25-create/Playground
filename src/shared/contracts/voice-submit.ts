...
export const voiceSubmitRequestSchema = z
  .object({
    ...
    notionDatabaseId: optionalLooseStringSchema,
    notionParentPageId: optionalLooseStringSchema,
...
export const makeWebhookPayloadSchema = z
  .object({
    ...
    notionDatabaseId: z.string().trim().max(512).default(''),
    notionParentPageId: z.string().trim().max(512).default(''),
